...
class RequestDataFactoryTest {
    ...
    void 빈_데이터가_필요로하는_경우(ActionType actionType, String command) {
        //given
        //when
        var data = RequestDataFactory.createData(List.of(command), actionType);
    ...
    void 빈_데이터가_필요하지_않은_경우(ActionType actionType, Class<?> type, List<String> commands) {
        //given
        //when
        var data = RequestDataFactory.createData(commands, actionType);
